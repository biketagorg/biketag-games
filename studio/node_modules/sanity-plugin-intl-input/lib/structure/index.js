...
var IntentLink = require('@sanity/state-router/lib/components/IntentLink');
...
var IntentLink__default = /*#__PURE__*/_interopDefaultLegacy(IntentLink);
...
var styles = {"loading":"_1LQXM8I-NPjX7653Ecj41o","loading--pulse":"_29gaD5YBPJg_GoviI1jH0H"};
...
function getConfig(type) {
  var _schema$fieldNames, _cfg$fieldNames, _schema$fieldNames2, _cfg$fieldNames2, _schema$messages, _cfg$messages, _schema$messages2, _cfg$messages2, _schema$messages3, _cfg$messages3, _schema$messages4, _cfg$messages4, _schema$messages5, _cfg$messages5, _schema$messages6, _cfg$messages6, _schema$messages7, _schema$messages7$del, _cfg$messages7, _cfg$messages7$delete, _schema$messages8, _schema$messages8$del, _cfg$messages8, _cfg$messages8$delete, _schema$messages9, _schema$messages9$tra, _cfg$messages9, _cfg$messages9$transl, _cfg$messages10, _cfg$messages10$trans, _cfg$messages11, _cfg$messages11$trans, _cfg$messages12, _cfg$messages12$trans, _cfg$messages13, _cfg$messages13$trans, _cfg$messages14, _cfg$messages14$trans, _cfg$messages15, _cfg$messages15$trans, _cfg$messages16, _cfg$messages16$trans;
  ...
  return {
    ...
    messages: {
      ...
      translationsMaintenance: {
        ...
        idStructureMismatch: (cfg === null || cfg === void 0 ? void 0 : (_cfg$messages11 = cfg.messages) === null || _cfg$messages11 === void 0 ? void 0 : (_cfg$messages11$trans = _cfg$messages11.translationsMaintenance) === null || _cfg$messages11$trans === void 0 ? void 0 : _cfg$messages11$trans.idStructureMismatch) || 'document(s) with mismatched ID structures',
        ...
        referenceBehaviorMismatch: (cfg === null || cfg === void 0 ? void 0 : (_cfg$messages15 = cfg.messages) === null || _cfg$messages15 === void 0 ? void 0 : (_cfg$messages15$trans = _cfg$messages15.translationsMaintenance) === null || _cfg$messages15$trans === void 0 ? void 0 : _cfg$messages15$trans.referenceBehaviorMismatch) || 'document(s) with mismatched reference behaviors',
        fix: (cfg === null || cfg === void 0 ? void 0 : (_cfg$messages16 = cfg.messages) === null || _cfg$messages16 === void 0 ? void 0 : (_cfg$messages16$trans = _cfg$messages16.translationsMaintenance) === null || _cfg$messages16$trans === void 0 ? void 0 : _cfg$messages16$trans.fix) || 'Fix'
      }
    }
  };
}
...
var getSanityClient = function getSanityClient() {
  return client__default['default'];
};
...
var getLanguagesFromOption = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee2(langs) {
...
var SanityFlag = function SanityFlag(props) {
  return /*#__PURE__*/React.createElement("svg", _extends__default['default']({
    width: "24",
    height: "18",
    viewBox: "0 0 24 18",
    fill: "none",
...
var TranslationLink = function TranslationLink(_ref) {
  ...
  return /*#__PURE__*/React.createElement(IntentLink__default['default'], {
    intent: "edit",
    params: {
      id: translatedDocId,
      type: schema.name
    },
    className: classnames((_classnames = {}, _defineProperty__default['default'](_classnames, styles$1.entry, true), _defineProperty__default['default'](_classnames, styles$1.disabled, existing === null), _defineProperty__default['default'](_classnames, styles$1.selected, currentLanguage === lang.name), _classnames)),
    onClick: function onClick(props) {
      if (existing === undefined) {
        var fieldName = config.fieldNames.lang;
        getSanityClient().createIfNotExists(_objectSpread(_objectSpread({}, baseDocument ? baseDocument : {}), {}, _defineProperty__default['default']({
...
var MaintenanceTab = /*#__PURE__*/function (_React$Component) {
  _inherits__default['default'](MaintenanceTab, _React$Component);
  ...
  function MaintenanceTab() {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "_sanityClient", getSanityClient());
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "fetchInformation", /*#__PURE__*/_asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee() {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "fixIdStructureMismatchDocuments", /*#__PURE__*/_asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee4() {
      var selectedSchema, config, refsFieldName, idStructureMismatchDocuments;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              idStructureMismatchDocuments = _this.idStructureMismatchDocuments; // remove old refs

              _context4.next = 7;
              return Promise.all(Array.from(new Set(idStructureMismatchDocuments.map(function (d) {
                  ...
                  return _regeneratorRuntime__default['default'].wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          _context2.next = 2;
                          return _this._sanityClient.patch(id).set(_defineProperty__default['default']({}, refsFieldName, [])).commit();
            ...
            case 7:
              _context4.next = 9;
              return Promise.all(idStructureMismatchDocuments.map( /*#__PURE__*/function () {
                var _ref4 = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee3(d) {
                    ...
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        ...
                        case 8:
                          ...
                          _context3.next = 11;
                          return _this._sanityClient.patch(baseId).setIfMissing(_defineProperty__default['default']({}, refsFieldName, [])).append(refsFieldName, [{
                            _key: newId,
                            lang: lang,
                            ref: {
                              _type: 'reference',
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "fixLanguageFields", /*#__PURE__*/_asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee6() {
          ...
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              return Promise.all(documents.map( /*#__PURE__*/function () {
                var _ref6 = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee5(d) {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "fixTranslationRefs", /*#__PURE__*/_asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee8() {
          ...
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              return Promise.all(_this.baseDocuments.map( /*#__PURE__*/function () {
                var _ref8 = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee7(d) {
                  var docs, refsCount;
                    ...
                    while (1) {
                      switch (_context7.prev = _context7.next) {
                        case 0:
                          ...
                          _context7.next = 4;
                          return _this._sanityClient.patch(d._id, {
                            set: _defineProperty__default['default']({}, refsFieldName, refsCount != docs.length && config.referenceBehavior !== ReferenceBehavior.DISABLED ? translatedDocuments.map(function (doc) {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "fixOrphanedDocuments", /*#__PURE__*/_asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee10() {
      var basedocuments;
          ...
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              return Promise.all(_this.translatedDocuments.map( /*#__PURE__*/function () {
                var _ref10 = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee9(d) {
                  var base;
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "fixReferenceBehaviorMismatch", /*#__PURE__*/_asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee12() {
      var selectedSchema, config, refsFieldName, translatedDocuments;
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              ...
              _context12.next = 7;
              return Promise.all(_this.baseDocuments.map( /*#__PURE__*/function () {
                var _ref12 = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee11(d) {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "onSchemaTypeChange", function (event) {
  ...
  _createClass__default['default'](MaintenanceTab, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default['default'].createElement("div", {
        className: classnames((_classNames = {}, _defineProperty__default['default'](_classNames, styles$2.root, true), _defineProperty__default['default'](_classNames, styles$2.disabled, pending), _classNames))
      ...
      })), /*#__PURE__*/React__default['default'].createElement(ChevronDown, null)), !!selectedSchema && /*#__PURE__*/React__default['default'].createElement("div", {
        className: styles$2.dashboard
      }, /*#__PURE__*/React__default['default'].createElement("div", {
        className: styles$2.entry
      }, /*#__PURE__*/React__default['default'].createElement("p", null, info.idStructureMismatch.length, " ", config === null || config === void 0 ? void 0 : (_config$messages2 = config.messages) === null || _config$messages2 === void 0 ? void 0 : (_config$messages2$tra = _config$messages2.translationsMaintenance) === null || _config$messages2$tra === void 0 ? void 0 : _config$messages2$tra.idStructureMismatch), info.idStructureMismatch.length > 0 && /*#__PURE__*/React__default['default'].createElement("button", {
        onClick: this.fixIdStructureMismatchDocuments
      }, config === null || config === void 0 ? void 0 : (_config$messages3 = config.messages) === null || _config$messages3 === void 0 ? void 0 : (_config$messages3$tra = _config$messages3.translationsMaintenance) === null || _config$messages3$tra === void 0 ? void 0 : _config$messages3$tra.fix)), /*#__PURE__*/React__default['default'].createElement("div", {
        className: styles$2.entry
      }, /*#__PURE__*/React__default['default'].createElement("p", null, info.missingLanguageField.length, " ", config === null || config === void 0 ? void 0 : (_config$messages4 = config.messages) === null || _config$messages4 === void 0 ? void 0 : (_config$messages4$tra = _config$messages4.translationsMaintenance) === null || _config$messages4$tra === void 0 ? void 0 : _config$messages4$tra.missingLanguageField), info.missingLanguageField.length > 0 && /*#__PURE__*/React__default['default'].createElement("button", {
        onClick: this.fixLanguageFields
      }, config === null || config === void 0 ? void 0 : (_config$messages5 = config.messages) === null || _config$messages5 === void 0 ? void 0 : (_config$messages5$tra = _config$messages5.translationsMaintenance) === null || _config$messages5$tra === void 0 ? void 0 : _config$messages5$tra.fix)), /*#__PURE__*/React__default['default'].createElement("div", {
        className: styles$2.entry
      }, /*#__PURE__*/React__default['default'].createElement("p", null, info.missingDocumentRefs.length, " ", config === null || config === void 0 ? void 0 : (_config$messages6 = config.messages) === null || _config$messages6 === void 0 ? void 0 : (_config$messages6$tra = _config$messages6.translationsMaintenance) === null || _config$messages6$tra === void 0 ? void 0 : _config$messages6$tra.missingDocumentRefs), info.missingDocumentRefs.length > 0 && /*#__PURE__*/React__default['default'].createElement("button", {
        onClick: this.fixTranslationRefs
      }, config === null || config === void 0 ? void 0 : (_config$messages7 = config.messages) === null || _config$messages7 === void 0 ? void 0 : (_config$messages7$tra = _config$messages7.translationsMaintenance) === null || _config$messages7$tra === void 0 ? void 0 : _config$messages7$tra.fix)), /*#__PURE__*/React__default['default'].createElement("div", {
        className: styles$2.entry
      }, /*#__PURE__*/React__default['default'].createElement("p", null, info.orphanDocuments.length, " ", config === null || config === void 0 ? void 0 : (_config$messages8 = config.messages) === null || _config$messages8 === void 0 ? void 0 : (_config$messages8$tra = _config$messages8.translationsMaintenance) === null || _config$messages8$tra === void 0 ? void 0 : _config$messages8$tra.orphanDocuments), info.orphanDocuments.length > 0 && /*#__PURE__*/React__default['default'].createElement("button", {
        onClick: this.fixOrphanedDocuments
      }, config === null || config === void 0 ? void 0 : (_config$messages9 = config.messages) === null || _config$messages9 === void 0 ? void 0 : (_config$messages9$tra = _config$messages9.translationsMaintenance) === null || _config$messages9$tra === void 0 ? void 0 : _config$messages9$tra.fix)), /*#__PURE__*/React__default['default'].createElement("div", {
        className: styles$2.entry
      }, /*#__PURE__*/React__default['default'].createElement("p", null, info.referenceBehaviorMismatch.length, " ", config === null || config === void 0 ? void 0 : (_config$messages10 = config.messages) === null || _config$messages10 === void 0 ? void 0 : (_config$messages10$tr = _config$messages10.translationsMaintenance) === null || _config$messages10$tr === void 0 ? void 0 : _config$messages10$tr.referenceBehaviorMismatch), info.referenceBehaviorMismatch.length > 0 && /*#__PURE__*/React__default['default'].createElement("button", {
        onClick: this.fixReferenceBehaviorMismatch
      }, config === null || config === void 0 ? void 0 : (_config$messages11 = config.messages) === null || _config$messages11 === void 0 ? void 0 : (_config$messages11$tr = _config$messages11.translationsMaintenance) === null || _config$messages11$tr === void 0 ? void 0 : _config$messages11$tr.fix))));
    }
  }, {
    key: "i18nSchemas",
    get: function get() {
    ...
    get: function get() {
      var config = getConfig();
      if (config.idStructure === IdStructure.DELIMITER) return this.state.documents.filter(function (d) {
    ...
    key: "idStructureMismatchDocuments",
    get: function get() {
      var config = getConfig();
      if (config.idStructure === IdStructure.DELIMITER) return this.state.documents.filter(function (d) {
        return d._id.startsWith(I18nPrefix);
