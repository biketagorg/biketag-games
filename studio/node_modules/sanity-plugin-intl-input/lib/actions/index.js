...
var ConfirmDelete = require('@sanity/desk-tool/lib/components/ConfirmDelete');
...
var ConfirmDelete__default = /*#__PURE__*/_interopDefaultLegacy(ConfirmDelete);
...
var PublishWithi18nAction = function PublishWithi18nAction(props) {
  ...
  var syncState = reactHooks.useSyncState(props.id, props.type); // typing does not accept type anymore - used to be required --> @TODO remove if possible
  ...
  var _React$useState = React.useState(false),
      ...
      publishing = _React$useState2[0],
      setPublishing = _React$useState2[1];

  React.useEffect(function () {
    if (publishing && !props.draft) setPublishing(false);
  }, [publish.disabled, props.draft, syncState.isSyncing]);
  return {
    disabled: publishing || publish.disabled || syncState.isSyncing,
    label: publishing ? (_config$messages = config.messages) === null || _config$messages === void 0 ? void 0 : _config$messages.publishing : (_config$messages2 = config.messages) === null || _config$messages2 === void 0 ? void 0 : _config$messages2.publish,
    onHandle: function () {
      var _onHandle = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee() {
        var _getBaseLanguage, _props$draft;

        var client, fieldName, refsFieldName, langs, languageId, translatedDocuments;
        return _regeneratorRuntime__default['default'].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 6:
                langs = _context.sent;
                languageId = getLanguageFromId(props.id) || ((_getBaseLanguage = getBaseLanguage(langs, config.base)) === null || _getBaseLanguage === void 0 ? void 0 : _getBaseLanguage.name);
                _context.next = 10;
                return client.createIfNotExists({
                  _id: props.id,
                  _type: props.type,
                  _createdAt: moment().utc().toISOString()
                });

              case 10:
                _context.next = 12;
                return client.patch(((_props$draft = props.draft) === null || _props$draft === void 0 ? void 0 : _props$draft._id) || props.id, {
              ...
              case 19:
                _context.next = 21;
                return client.patch(baseDocumentId, {
...
var DeleteWithi18nAction = function DeleteWithi18nAction(props) {
  ...
  return {
    ...
    dialog: isConfirmDialogOpen && {
      ...
      title: 'Delete',
      content: /*#__PURE__*/React__default['default'].createElement(ConfirmDelete__default['default'], {
        draft: props.draft,
        ...
        onConfirm: /*#__PURE__*/_asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee() {
          var translatedDocuments, transaction;
          return _regeneratorRuntime__default['default'].wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                ...
                case 5:
                  ...
                  translatedDocuments.forEach(function (doc) {
                    return transaction["delete"](doc._id);
                  });
                  _context.next = 10;
